...
| Inventario | **`adr/ADR-0034`** (es la fuente real: las dos specs son esqueletos), `03_MODULES/INVENTORY_SPEC.md`, `03_MODULES/WAREHOUSE_OPERATIONS_SPEC.md`, `04_PLATFORM/STATE_MACHINES.md` |
